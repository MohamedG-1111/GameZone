...
namespace GameZone.Migrations
{
    ...
    [Migration("20260419092419_Intial")]
            ...
            modelBuilder.Entity("GameZone.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("EnabalNotifications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.ToTable("AspNetUsers", null, t =>
                        {
                            t.HasCheckConstraint("CK_User_Phone", "PhoneNumber IS NOT NULL AND LEN(PhoneNumber) = 11 AND PhoneNumber LIKE '01[0-9]%'");
